...
module MscrmControls.Smartassist.Suggestion {
	export class ViewTemplates {
		...
		public static SuccessMessageTemplate = '<div id= {0} class="' + Constants.CustomActionSuccessMessageClass + '" style="display: flex;">{1}</div>';
		public static FailureMessageTemplates = '<div id = {0} class="' + Constants.CustomActionFailureMessageClass + '"style="display: flex;">{1}</div>';
	}
}