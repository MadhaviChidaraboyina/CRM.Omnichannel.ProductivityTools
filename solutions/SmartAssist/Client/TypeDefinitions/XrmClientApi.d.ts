...
declare namespace XrmClientApi {
	...
	export type PageInput =
		...
		| TaskBasedFlowPageInput;

	/**
	 * The input needed to create an instance of the TaskBasedFlow.
	 */
	export interface TaskBasedFlowPageInput {

		/**
		 * The entity type name of the primary entity associated with the Task Based Flow.
		 */
		entityName?: string;

		/**
		 * The id of the record to load in the TaskBasedFlow
		 */
		entityId?: string;

		/**
		 * The unique name of the TaskBasedFlow.
		 */
		uniqueName: string;
	}
