...
namespace PVSPackage
{
    ...
    public class PackageProductivityMacros : ImportExtension
    {
        /// <summary>
        ...
        {
            get { return "This solution provides web resources to use Macros designer and APIs to automate business process tasks."; }
        }
