        ...
        req(["draft-js"], function (Draft) {
            ...
            req(["SwaggerParser", "resources", "core/main"], function (SwaggerParser, Resources, DesignerCore) {
                ...
                rpc.register(SharedDefines.DesignerMessages.Initialize, function (options) {
                    ...
                    let designerOptions: SharedDefines.ILogicAppDesignerOptions = JSON.parse(options);
                    let builtInTypeServiceFactory = function (analytics, schemaVersion) {
                        /*let options = {
                            openApiConnection: false,
                            showScopeActions: false,
                        ...
                        //return new BuiltinProvider({builtInTypeService:new DesignerCore.LogicAppsBuiltInTypeService(schemaVersion, options)});
                    };
                    let recommendationServiceFactory = function (analytics, schemaVersion) {
                        return new HostService.SmartRecommendationImpl({builtInTypeService:builtInTypeServiceFactory(analytics, schemaVersion)},designerOptions
                        );
                    }
