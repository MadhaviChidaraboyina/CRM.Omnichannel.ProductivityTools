...
namespace Microsoft.CIFramework.Internal {
	...
	export function insertNotesClient(notesDetails: Map<string,any>/*, width: number*/): Promise<any>{
		...
		return new Promise(function (resolve,reject) {
			...
			let htmlString = '<div id= "notesHeaderIdCIF" class="notesHeader"><div class="notesHeaderSpan_CIF" aria-label="' + Utility.getResourceString("ADD_NOTE_TEXT") + '">' + Utility.getResourceString("ADD_NOTE_TEXT") + '</div><div class="notesCloseSpanDiv"></div></div><div class="notesbodyDivider_CIF"></div><div style="height: 14px;"></div>';
			...
			span.setAttribute("aria-label", Utility.getResourceString("CLOSE_BUTTON_TEXT"));
			...
			newTextArea.setAttribute('placeholder',  Utility.getResourceString("START_NOTES_TOOLTIP_TEXT"));
			newTextArea.setAttribute("aria-label", Utility.getResourceString("NOTES_TOOLTIP_TEXT"));
			...
			saveBtn.innerText = Utility.getResourceString("ADD_NOTE_TEXT");
			saveBtn.tabIndex = 0;
			saveBtn.setAttribute("aria-label", Utility.getResourceString("ADD_NOTE_TEXT"));
			var cancelBtn = document.createElement("BUTTON");
			cancelBtn.classList.add("notesCancelButtonCIF");
			cancelBtn.innerText = Utility.getResourceString("CANCEL_BUTTON_TEXT");
			cancelBtn.tabIndex = 0;
			cancelBtn.setAttribute("aria-label", Utility.getResourceString("CANCEL_BUTTON_TEXT"));
