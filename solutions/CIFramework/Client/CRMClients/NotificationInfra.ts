...
namespace Microsoft.CIFramework.Internal {
	...
	export function renderEventNotification(header:any,body:any,actions:any,notificationType:any,eventType:any): Map<any,any>{
		...
		if(notificationType[0].search(MessageType.softNotification) != -1){ //For Soft notification
			...
			if(eventType.search(Constants.Chat) != -1){
				toastDiv.insertAdjacentHTML('beforeend', '<div id="CIFToast" tabindex="0" aria-label="Notification Window" class="CIFToastDiv"><div class="header_NotificationType_CIF"></div><div aria-label="Notification Header" tabindex="0" class="header_CIF"><div class="CIFHeaderIconDiv"><img class="CIFHeaderImage" src="/webresources/chat_icon.svg" alt="CIF Header Image"></div><div class="headerKeyCIF"></div><div tabindex="0" id="headerTimerCIFId" class="headerTimerCIF"></div><div class="headerNameCIF"></div><div style="height:8px;"></div></div><div></div><div aria-label="Notification Body" class="bodyDivCIF"><div class="bodyDivider_CIF"></div><div style="height:8px"></div><p class="body_CIF"><div style="height: 2px;"></div></div></div>');
	...
	*/
	export function renderSoftNotification(header: any, body: any, notificationType: string): Map<string,any>{
		...
		toastDiv.insertAdjacentHTML('afterbegin', '<div tabindex="0" id="CIFSoftToast" class="CIFSoftNotificationToast"><div tabindex="0" id="header_SoftNotification_CIF" class="headerSoftNotification_CIF"><div style="height:14px"></div></div><div tabindex="0" id="bodyDivSoftToastCIF" class="bodyDivSoftToast_CIF"></div></div>');
		//Constructing header
		let panelWidth = "100%";
