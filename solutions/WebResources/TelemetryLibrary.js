...
(function (AppCommon) {
    var TelemetryReporter = (function () {
        ...
        /// <summary>
        /// Post telemetry event immediately.
        /// </summary>
        /// <param name="event">Event data</param>
        TelemetryReporter.prototype.AddTelemetryEventImmediately = function (event) {
            this.AddTelemetryEvent(event);
        };
        /// <summary>
        ...
        TelemetryReporter.prototype.PostStartMarker = function (eventName, webResourceName, functionName, currentId, parentId) {
            ...
            this.AddTelemetryEventImmediately(telemetryevent);
        };
        /// <summary>
