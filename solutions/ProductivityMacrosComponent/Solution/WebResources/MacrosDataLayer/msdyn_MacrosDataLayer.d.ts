...
declare namespace Microsoft.ProductivityMacros.MacrosDataLayer {
    class FPIHelper {
         ...
         */
        private static dataResponseSuccessHandling;
        /**
        * Function for dataResponse Failure Handling
        */
        private static dataResponseFailureHandling;
        private static handleInvalidRequestID;
        /**
         * Method to process FPI Post response
         * @param event Sent by FPI iframe with data
         */
        private static processIframeData;
        /**
         ...
         */
        private static createFPIRequestMessage;
        /**
...
declare namespace Microsoft.ProductivityMacros.MacrosDataLayer {
    class Utils {
        ...
        private static getRandomGuidSubstr;
...
declare namespace Microsoft.ProductivityMacros.MacrosDataLayer {
    class OrganizationSettings {
        ...
        readonly isSovereignCloud: boolean;
    }
