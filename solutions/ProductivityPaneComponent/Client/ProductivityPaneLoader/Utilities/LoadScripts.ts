    ...
    export class LoadScripts {
        ...
        public static loadLogicAppExecutor() {
            try {
                ...
                document.getElementsByTagName('body')[0].appendChild(macrosLibScript);
                Logger.logInfo(`${Constants.productivityToolsLogPrefix} Success: loaded msdyn_LogicAppExecutor_v2.js`);
            } catch (error) {
                Logger.logError(
        ...
        public static loadMacrosDataLayer() {
            try {
                ...
                document.getElementsByTagName('body')[0].appendChild(macrosLibScript);
                Logger.logInfo(`${Constants.productivityToolsLogPrefix} Success: loaded msdyn_MacrosDataLayer.js`);
            } catch (error) {
                Logger.logError(
