...
async function getCRMData() {
    ...
    try {
        let result = await (window.top as any).Xrm.WebApi.retrieveMultipleRecords("msdyn_sessiontemplate", "?$filter=msdyn_sessiontemplateid eq '" + sessionTemplateId +"'&$expand=msdyn_msdyn_agentscript_v2_msdyn_sessiontemplat($select=msdyn_name,msdyn_productivityagentscriptid,msdyn_description)&$select=msdyn_name");   
