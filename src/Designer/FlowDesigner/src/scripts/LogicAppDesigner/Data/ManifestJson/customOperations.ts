...
export const customConnectors:Designer.RecommendationConnector[]=[
    {  
        ...
        title: AgentScriptUtils.getResourceString("LADESIGNER_CALLSCRIPT_CONNECTOR_DISPLAYNAME")
}];
...
export const CustomActions: Designer.ApiOperation[] =[ 
    ...
    properties: {
        api: {
            brandColor:DesignerConstants.Constants.BrandColor,
            displayName: AgentScriptUtils.getResourceString("LADESIGNER_CALLSCRIPT_CONNECTOR_DISPLAYNAME"),
            iconUri: DesignerConstants.icons.operations.setcallscript,
            id: DesignerConstants.manifestConnectorIds.callscript,
        },
        summary: AgentScriptUtils.getResourceString("LADESIGNER_SETCALLSCRIPT_SUMMARY"), //"Set Default Call Script",
        description: AgentScriptUtils.getResourceString("LADESIGNER_SETCALLSCRIPT_DESCRIPTION"),//call script
...
export const CustomTriggers: Designer.ApiOperation[] =[   
    {
        ...
        properties: {
            ...
            summary: AgentScriptUtils.getResourceString("LADESIGNER_START_SUMMARY"), //"Set Default Call Script",
            description: AgentScriptUtils.getResourceString("LADESIGNER_START_DESCRIPTION"),//call script
            environmentBadge: testEnvBadge,
            operationType: 'start',
